    ...
    if (!yourName || !partnerName) {
        ...
        <path
            ...
            <a class="btn btn-outline-secondary"
                href="https://www.instagram.com/share?url=${encodeURIComponent(window.location.href)}&caption=${encodeURIComponent(message)}"
                target="_blank" rel="noopener noreferrer"><i class="fa fa-share"></i><i class="bi bi-share"></i><svg
                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                href="https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(window.location.href)}&quote=${encodeURIComponent(message)}"
